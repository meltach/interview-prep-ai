...
import { cn } from '@/lib/utils'; // Assuming you have a utils file with cn function for conditional classes
// ChevronLeft,
...
export function SideNav() {
    ...
    const isSessionActive = (sessionId: string) => {
        return pathname === `/interview-prep/history/${sessionId}`;
    };
                            ...
                            {isLoading ? (
                                ...
                                <ul className="py-2">
                                    {pastSessions.map((session) => (
                                        <li key={session.id}>
                                            <Link href={`/interview-prep/history/${session.id}`} passHref>
                                                <div
                                                    className={cn(
