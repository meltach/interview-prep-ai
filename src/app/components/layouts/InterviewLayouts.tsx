    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
            ...
            <div className="flex flex-1 pt-16 overflow-hidden">
                ...
                <motion.main
                    className="flex-1 flex flex-col min-h-[calc(100vh-4rem)] transition-transform duration-300 ease-in-out"
                    style={{
                ...
                >
                    ...
                    <div className="flex-1 flex flex-col items-center justify-start w-full max-w-4xl mx-auto p-4 md:p-6 lg:p-8 overflow-y-auto custom-scrollbar">
                        {children}
                    </div>
                </motion.main>
            </div>
